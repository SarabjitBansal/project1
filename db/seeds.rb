...
f1 = Foodtype.create(:title => 'Vegetarian Friendly',:shortname = 'VF')
f2 = Foodtype.create(:title => 'Vegan Friendly',:shortname = 'VG')
f3 = Foodtype.create(:title => 'Gluten Free',:shortname = 'GF')
f4 = Foodtype.create(:title => "Dairy Free",:shortname = 'DF')
...
,extra virgin olive oil, to serve (optional),lemon wedges, to serve", :image => 'http://res.cloudinary.com/dbenxy2yz/image/upload/v1522840030/qyjeif1ztuhxkuzqu8he.jpg',:country => 'Australia', :city => 'Sydeny', :procedure => "Step 1 Cook pasta following packet instructions. Drain and return to pan.
